      ...
      html: (`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
            ...
            <![endif]-->
              ...
              <![endif]-->
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px">${req.body.influencerName} just filled out an influencer application</span></div><div></div></div></td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>Name: </strong>${req.body.influencerName}&nbsp;</div><div></div></div></td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>Email: </strong>${req.body.influencerEmail}&nbsp;</div><div></div></div></td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>Elevator pitch: </strong>${req.body.influencerPitch}&nbsp;</div><div></div></div></td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>Partners they're seeking: </strong>${req.body.influencerLooking}&nbsp;</div><div></div></div></td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>About their channel: </strong>${req.body.influencerAbout}&nbsp;</div><div></div></div></td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>How brands should contact them: </strong>${req.body.influencerContact}&nbsp;</div><div></div></div></td>
                  </tr>
                </tbody>
              </table></td>
                                                  </tr>
